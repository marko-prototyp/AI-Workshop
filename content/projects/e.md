---
letter: "E"
name: "Mini design system showcase"
...
---
WORKING TITLE
Usually the fictional product or brand name. Pick something
...
What does this brand believe? One paragraph.
Example: "Folio believes most software has too many features.
Everything in the brand should feel like restraint — narrow
...
- "Single accent color (not a palette). Used only for the cursor
  and active state."
- "Type ramp is six steps, all the same typeface, weight changes
  do the work."
- "Spacing is a 4-step scale. Anything that needs a 5th step is
  designed wrong."
...
showcase the system in context? Pick 3–5. Examples for Folio:
...
THREE REFERENCES
At least two should be real shipped systems (Stripe, Linear,
