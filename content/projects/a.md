...
WHO IS THIS FOR
Be specific. "Recruiters at design-led product companies who are
hiring senior IC roles" beats "potential employers."
...
Examples: "I think most product design is overpolished and
underthought, and the work shows the thinking." Or: "I move between
brand and product, and the site treats them as one practice."

THE FORMAT DECISION
Single page, multi-page, or hybrid? Pick now and commit.
- Single page: stronger for one strong identity, harder for long
  case studies.
- Multi-page: better for case study depth, more nav design work.
- Hybrid: home is single-page, each case study has its own page.
  Most teams land here.

THREE REFERENCES
Three sites you admire and what specifically you admire about each.
