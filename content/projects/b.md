...
"The behind-the-drafts version of Acme Redesign", "Acme Redesign,
in slow motion."
...
- Timeline: scroll = time. Each scroll moment is a moment in the
  project.
- Decision tree: branching points in the project, with paths.
- Before/after: pairs of screens, with a draggable wipe.

WHO IS THIS FOR
Hiring managers? Other designers? Future you? Each audience pulls
the writing in a different direction.
